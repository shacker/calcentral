class MyCampuslinksController < ApplicationController
  ...
  - Navigation consists of Main Categories, Subcategories, and On-page categories, aka Sections
  ...
  - RailsAdmin is currently whitelisting only the Models we want to display (in rails_admin.rb)
